...
return [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                'about' => 'site/about',
                'get-feed\/?<startPage:\d*>' => '/chareit/post/get-feed',
                'get-top' => '/chareit/post/get-top',
                'get-profile/<user_id:\d+>\/?<startPage:\d*>' => '/chareit/post/get-profile',
                'profile/<user_id:\d+>/' => '/chareit/default/profile',
                'feed' => '/chareit/default/feed',
                'top' => '/chareit/default/top',
